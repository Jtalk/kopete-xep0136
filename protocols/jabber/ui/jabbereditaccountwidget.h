...
private slots:
    ...
    void slotAutomaticArchivingEnable(bool,QString scope);
    void slotDefaultPreferenceChanged(QString saveMode,QString otr,uint expire);
    void slotArchivingMethodChanged(QString method,QString use);
